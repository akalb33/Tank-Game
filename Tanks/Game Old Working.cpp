...
void Game::HandleCommunications()
{
   if (mSendingMessage)
   {
      mMessage.informationMessage.angle = mpOurTank->mAngle;
      mMessage.informationMessage.xPosition = mpOurTank->mX;
      mMessage.informationMessage.yPosition = mpOurTank->mY;
      mMessage.informationMessage.xVelocity = mpOurTank->mVelocityX;
      mMessage.informationMessage.yVelocity = mpOurTank->mVelocityY;
   ...
   else
   {
      ...
      if (mSocket.receive(mMessage.c, sizeof(Message), received) == sf::Socket::Status::Done)
      {
         ...
         mpTheirTank->mAngle = mMessage.informationMessage.angle;
         mpTheirTank->mX = mMessage.informationMessage.xPosition;
         mpTheirTank->mY = mMessage.informationMessage.yPosition;
         mpTheirTank->mVelocityX = mMessage.informationMessage.xVelocity;
         mpTheirTank->mVelocityY = mMessage.informationMessage.yVelocity;
         mSendingMessage = true;
      }
   }
}
